...
public class Test {
	public static void main(String[] args) {
		...
		//template.update("Insert into employees values(?,?,?)",25,"twentyfive@gmail.com",25677.00);
		
		//template.update("Update employees set email=? where empId=?","updated25@gmail.com",25);
		
	//	template.update("Delete from employees where empId=?",25);
